    ...
    <main class="dashboard-content">
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <form method="POST" action="{{ route('admin.kategori.update', $kategori->id) }}" class="tambah-form">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        <label class="form-label">
                            <input type="checkbox" name="status" value="1" {{ old('status', $kategori->status) ? 'checked' : '' }}>
                            Aktif
                        </label>
                    </div>
