    ...
    <main class="dashboard-content">
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <form method="POST" action="{{ route('admin.foto.store') }}" enctype="multipart/form-data" class="tambah-form">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="judul" class="form-input" placeholder="Judul foto" value="{{ old('judul') }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Deskripsi (opsional)</label>
                        <div class="input-group">
                            <textarea name="deskripsi" class="form-textarea" rows="3" placeholder="Deskripsi">{{ old('deskripsi') }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="file-upload">
                            <label class="file-upload-label">
                                <input type="file" name="file" class="file-upload-input" accept="image/*" required onchange="previewImage(this)">
